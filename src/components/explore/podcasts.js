          ...
          return (
            ...
            >
              <Link href={`/explore/podcasts/${slug}`}>
                <img
                  src="/images/explore/podcasts-img.png"
                  alt=""
                  className="w-full absolute z-[0] h-full object-cover rounded-[8px]"
                />
                <div className="w-full h-full absolute bg-gradient-to-r from-[#1111114D] to-[#0521552c] z-[1]"></div>
                ...
                <img
                  ...
                  alt=""
                  className="absolute z-[7] bottom-0 right-0 mr-[3%] md:mr-[7%] mb-[1.7rem] md:mb-[3rem] opacity-0 play-container transition-all ease-in-out duration-500"
                />
                <div className="flex flex-row justify-between px-[2%] md:px-[5%] mt-[300px] items-center absolute z-[5] bottom-0 w-full mb-[1rem] md:mb-[2rem]  gap-2 md:gap-[50px]">
